...
- human-readable catalog of all 91 method specifications: [GSIA method-specification catalog](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-preprint/formulas/gsia-v2-formula-catalog.md);
