...
- required sensor, product, band, preprocessing, meteorological, or ancillary inputs;
- spatial and temporal operators and output units;
- physical rationale and, where recorded, a context source;
- capability family, method role, provisional contribution class, implementation maturity, and event-evidence status;
- an intended-use/inference-limit field, whose specificity varies by record;
- calibration and validation status;
- formula version, audit date, and source commit.
...
The release audit used the Atlas registry, Limn Atlas deployment, renderable evalscripts, automated test suite, event-source links, reviewed bookmarks, and associated public research documentation as reconciled on 21 July 2026. The version 2 audit ran against source snapshot `e50c2eda5cf405c7693e5210e04894c691e5f2eb`. The version 3 corrections in Section 4.6 were applied and re-verified against snapshot `fd00b890c16105d2e011f85d9e182ec5b709ab57`, tagged `gsia-v3-audit`, which is the snapshot this version describes. That implementation repository has since been made private. A public Atlas-only copy of 21 relevant registry, evalscript, evidence, audit, and test files from that snapshot is available at the `gsia-v3-audit` tag in [globe-and-atlas/limn-atlas](https://github.com/globe-and-atlas/limn-atlas/tree/gsia-v3-audit) and was confirmed byte-identical before that tag was created. As detailed in the availability list, the COG renderer and offset regression test are not in the public copy. Counts are properties of those versioned snapshots, not permanent properties of the project. The complete entry-level inventory is supplied with this preprint.
...
- human-readable catalog of all 91 method specifications: [GSIA method-specification catalog](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/formulas/gsia-v2-formula-catalog.md);
- machine-readable 91-record supplement (version 3): [GSIA v3 status supplement](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/preprint/gsia_preprint_v3_status_supplement_2026-07-25.csv);
- superseded version 2 supplement, retained for comparison: [GSIA v2 status supplement](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/preprint/gsia_preprint_v2_status_supplement_2026-07-21.csv);
- version 2 to version 3 erratum: [GSIA v2 erratum](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/preprint/gsia_preprint_v2_erratum_2026-07-25.md);
- structural-audit methods and interpretation: [`analysis/band-algebra/audit_report.md`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/analysis/band-algebra/audit_report.md);
- machine-readable structural summary: [`analysis/band-algebra/audit_summary.json`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/analysis/band-algebra/audit_summary.json);
- enumerated formula space: [`analysis/band-algebra/candidate_formula_space.csv`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/analysis/band-algebra/candidate_formula_space.csv);
- exact established-index crosswalk: [`analysis/band-algebra/known_index_crosswalk.csv`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/analysis/band-algebra/known_index_crosswalk.csv);
- 91-record applicability crosswalk: [`analysis/band-algebra/gsia_registry_applicability.csv`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/analysis/band-algebra/gsia_registry_applicability.csv);
- executable audit and regression tests: [`scripts/audit_band_algebra.py`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/scripts/audit_band_algebra.py) and [`tests/test_band_algebra_audit.py`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/tests/test_band_algebra_audit.py);
- reference analysis environment: [`analysis/band-algebra/requirements.txt`](https://github.com/globe-and-atlas/remote-sensing-research/blob/gsia-v3-submission/analysis/band-algebra/requirements.txt);
...
All registry and structural-audit links above are pinned to the immutable tag `gsia-v3-submission`, created for this submission from the final reviewed commit. The earlier `gsia-v3-preprint` tag is retained unmoved and predates corrections to the formula catalog and erratum, so it should not be used to resolve this version. The human-readable catalog presents the proposed and implemented formula fields for every record, organized by capability family. The accompanying CSV contains the same governed records together with formula version, method role, contribution class, maturity, implementation state, calibration and validation status, bookmark-date semantics, display-QC metadata, and source snapshot.
...
NASA Jet Propulsion Laboratory (NASA/JPL). (2025). NASA-ISRO Synthetic Aperture Radar (NISAR). Mission statistics; launch date 30 July 2025. [https://www.jpl.nasa.gov/missions/nasa-isro-synthetic-aperture-radar-nisar/](https://www.jpl.nasa.gov/missions/nasa-isro-synthetic-aperture-radar-nisar/)
